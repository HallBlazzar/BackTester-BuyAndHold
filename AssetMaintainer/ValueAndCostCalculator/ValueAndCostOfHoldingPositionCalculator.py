...
class ValueAndCostOfHoldingPositionCalculator:
...
class OriginalValueCalculator:
    ...
    def append_original_value(self):
        self.__calculation_source.loc[:, 'original_value'] = self.__calculation_source['value'] + \
            (
                self.__calculation_source['close_price'] -
...
class CostCalculator:
    ...
    def __get_cost_when_original_value_less_than_maintenance_margin(self):
        return self.__calculation_source['initial_margin'] - self.__calculation_source['original_value']
